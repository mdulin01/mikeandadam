...
- **Status**: ✅ RESOLVED 2026-07-06 — verified live (upload, thumbnail, reload persistence, auto-memory sync). Fixed by the 07-05 overhaul: memories/ Storage path, week-id-or-number matching, plan seeded in Firestore, prepareImageForUpload pipeline.
